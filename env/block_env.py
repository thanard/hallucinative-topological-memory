"""
Block Wall Environment.

A green block `obj1` and a red wall `obs1` are on a table `table`.
The agent can apply a small displacement on the green block. If the block
